...
let kHighlightColor = UIColor(red: (111.0/255.0), green: (185.0/255.0), blue: (231.0/255.0), alpha: 1.0)
...
let kLightBlue =  UIColor(red: (111.0/255.0), green: (185.0/255.0), blue: (231.0/255.0), alpha: 1.0)

let namedColors = [
    "orange":  UIColor(red: (111.0/255.0), green: (185.0/255.0), blue: (231.0/255.0), alpha: 1.0),
    ...
    "blue":    UIColor(red: (111.0/255.0), green: (185.0/255.0), blue: (231.0/255.0), alpha: 1.0),
